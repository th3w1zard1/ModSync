...
Changes since [v2.0.0a1](https://github.com/th3w1zard1/ModSync/releases/tag/v2.0.0a1). GitHub releases are created manually (see `docs/manual-release.md`); retracted 2.1.x tags are not published.
